...
const warLogs3 = `14:10:00 База (Поющий Риф, [Остров свёрнут]) Остров "ЗАНЯТО ХИМАМИ /Остров-склад [3]" будет атакован кланом "Небесная_КанЦеляриЯ" 19.04.26 21:30 по мск.
